...
public class BattleManager : MonoBehaviour
{
    ...
    private GameObject RandomEnemySpawn()
    {
        ...
        var chosenEnemy = ObjectPooling.instance.CreateObject("enemy", waveInfo.enemyArray[enemyIndex]);
        //var chosenEnemy = ObjectPooling.instance.CreateObject(TagPooling.Enemy ,waveInfo.enemyArray[enemyIndex]);
        return chosenEnemy;
    }
