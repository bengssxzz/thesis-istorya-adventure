...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Delegate__ctor_m102966351BDF3F711589A2E9A2E52F8C9EABE54E (Delegate_tCFB2DEC2BDD896115C5E195E37FA1C71102C549D* __this, RuntimeObject* ___object0, intptr_t ___method1, const RuntimeMethod* method) 
{
	...
	if (MethodIsStatic((RuntimeMethod*)___method1))
	{
		...
		if (il2cpp_codegen_call_method_via_invoker((RuntimeMethod*)___method1))
			...
			if (isOpen)
				__this->___invoke_impl_1 = (intptr_t)&Delegate_Invoke_mFA304FBC9F729A71EB1F9338745927115A736EEB_OpenStatic;
			else
				{
	...
	else
	{
		...
		if (isOpen)
		{
			...
			{
				__this->___invoke_impl_1 = (intptr_t)&Delegate_Invoke_mFA304FBC9F729A71EB1F9338745927115A736EEB_OpenInst;
			}
		}
		else
		{
